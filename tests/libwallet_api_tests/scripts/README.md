...
* Running SL8 node, linked to private/public testnet. 
  ...
  [Manual](https://github.com/SL8examples/private-testnet) explaining how to run private testnet.
...
* Directory with pre-generated wallets
  ...
  By default, tests expect these wallets to be in ```/var/SL8/testnet_pvt```. 
